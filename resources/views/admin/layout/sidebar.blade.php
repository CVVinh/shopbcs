                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{route('admin.sanpham.hienthi')}}" class="nk-menu-link"><span class="nk-menu-text">Bảng Quảng Cáo</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{url('admin.caidat.thongtinshop.sua')}}" class="nk-menu-link"><span class="nk-menu-text">Thông Tin Shop</span></a>
                                        </li>
                                    </ul>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
