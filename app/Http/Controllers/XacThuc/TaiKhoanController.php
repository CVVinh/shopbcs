...
class TaiKhoanController extends Controller
{
    ...
    public function trangChu()
    {
        if(Auth::guard('kh')->check()){
            ...
            $danhMucPhoBien = DB::table('cthoadon')->select('sp_ma', DB::raw('sum(soluong) as slsp'))->groupBy('sp_ma')->having('slsp','>','0')->offset(0)->limit(15)->get();
            ...
            arsort($maxDanhMuc);
            return view('index', compact('danhMucSPs','spSales', 'maxDanhMuc'));
        }
